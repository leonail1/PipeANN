...
function run_10_1M() {
    ...
    ~/PipeANN/build/tests/search_disk_index uint8 $6 $NTHREADS $2 /data/lzg/sift-pipeann/sift1m/bigann_query.bin /data/lzg/sift-pipeann/sift1m/groundtruth_1m.bin $1 l2 pq $3 $4 25 30 35 40 50
}
...
run_10_1M 10 32 2 0 1 /data/lzg/sift-pipeann/sift1m/indices/1m | tee ./data/sift1m_pipeann_results.txt
